...
class Biology : AppCompatActivity(), View.OnClickListener {
    ...
    private var score = 0
    private val totalQuestion = bioQ.question.size
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = bioQ.question[currentQuestionIndex]
        ansA.text = bioQ.choices[currentQuestionIndex][0]
        ansB.text = bioQ.choices[currentQuestionIndex][1]
        ansC.text = bioQ.choices[currentQuestionIndex][2]
        ansD.text = bioQ.choices[currentQuestionIndex][3]
        ansE.text = bioQ.choices[currentQuestionIndex][4]
    ...
    override fun onClick(view: View) {
        ...
        if (clickedButton.id == R.id.btn_submit) {
            if (selectedAnswer.isNotEmpty()) {
                if (selectedAnswer == bioQ.correctAnswers[currentQuestionIndex]) {
                    score++
                } else {
