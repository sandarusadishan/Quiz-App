...
class Physics : AppCompatActivity(), View.OnClickListener {
    ...
    private var score = 0
    private val totalQuestion = phyQ.question.size
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = phyQ.question[currentQuestionIndex]
        ansA.text = phyQ.choices[currentQuestionIndex][0]
        ansB.text = phyQ.choices[currentQuestionIndex][1]
        ansC.text = phyQ.choices[currentQuestionIndex][2]
        ansD.text = phyQ.choices[currentQuestionIndex][3]
        ansE.text = phyQ.choices[currentQuestionIndex][4]
    ...
    override fun onClick(view: View) {
        ...
        if (clickedButton.id == R.id.btn_submit) {
            if (selectedAnswer.isNotEmpty()) {
                if (selectedAnswer == phyQ.correctAnswers[currentQuestionIndex]) {
                    score++
                } else {
