...
class Chemistry : AppCompatActivity(), View.OnClickListener {
    ...
    private var score = 0
    private val totalQuestion = chemQ.question.size
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = chemQ.question[currentQuestionIndex]
        ansA.text = chemQ.choices[currentQuestionIndex][0]
        ansB.text = chemQ.choices[currentQuestionIndex][1]
        ansC.text = chemQ.choices[currentQuestionIndex][2]
        ansD.text = chemQ.choices[currentQuestionIndex][3]
        ansE.text = chemQ.choices[currentQuestionIndex][4]
    ...
    override fun onClick(view: View) {
        ...
        if (clickedButton.id == R.id.btn_submit) {
            if (selectedAnswer.isNotEmpty()) {
                if (selectedAnswer == chemQ.correctAnswers[currentQuestionIndex]) {
                    score++
                } else {
